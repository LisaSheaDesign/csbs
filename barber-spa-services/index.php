...
<html lang="en">
	...
	<body>
		<div id="wrapper" class="container">
			...
			<h3>The Leading Man / <span>$38</span></h3>
			<p>Men who have hair below their shoulders. Includes a shampoo and hot towel.</p>
			<h3>The Grip / <span>$22</span></h3>
			<p>Same length all the way around. Includes Shampoo, line-up, straight razor neck shave, and a hot towel.</p> 
			<h3>The In-Bee-Tween / <span>$14</span></h3>
			<p>The look of a clean, fresh cut without the full hair cut. Just a touch-up. Shampoo not included.</p>
			<h3>Beard/Mustache Trim / <span>$7</span></h3>
			<h3>Neck Clean Up / <span>$7</span></h3>
			<h3>Straight-Razor Face/Head Shave / <span>$30</span></h3>
			<h3>Hair design / <span>$12+</span></h3>	
			<h2>Women</h2>	
			<h3>Vixen (haircut, shampoo, blow-dry) / <span>$45</span></h3>
			<h3>Bang Trim / <span>$7</span></h3>
			<h3>Blow Dry / <span>Starts at $35+</span></h3>	
			<h3>Special Style and Up-do's / <span>$60</span> consultations required</h3>
			<h3>Hair Designs / <span>Starts at $12</span></h3>
			<p>Reveal your unique style with creative hair designs. (For kids, ladies & gentlemen)</p>
			<h2>Kids</h2>
			<h3>Screen Writer / <span>$20</span></h3>

...
<html lang="en">
	...
	<meta charset="utf-8" />
	<title>PACKAGES - Barber Shop Spa - Cuts, Shaves, Hair Color, &amp; MAN-icures - Christopher Styles Barber Spa</title>
	...
	<body>
		<div id="wrapper" class="container">
			...
			<div class="contentWrap">
				<section class="packagesPage">
					<h1>Packages</h1>
					<div class="callout">
						<p>Our packages are made to better cater to our customer. We have a package that will fit everyone!</p>
						</div>
						<h2>MEN</h2>
